...
<body>
	<div class="map_wrap">
		<div id="map"
			style="width: 700px; height: 550px; position: relative; overflow: hidden;"></div>
	...
	<script type="text/javascript"
		src="//apis.daum.net/maps/maps3.js?apikey=d1d5e5ad2e3cb3461622dec6c0af6825&libraries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
		...
		function addMarker(position, idx, title) {
			...
			imageSize = new daum.maps.Size(26, 27), // 마커 이미지의 크기
			imgOptions = {
