...
<div class="contact_container">
	...
	<div class="contact_wrap">
		<div class="contact_content">
			<div class="step_img"><span class="step_box">Step 1</span></div>
			북 마 크 <br> -가고싶은 또는 관심있는 여행지 그리고 맛집들 까지 북마크(찜하기)로 저장할 수 있습니다.<br>
			<div class="contact_img_wrap"><img src="img/contact/bookmark.jpg" class="contact_img"></div>
		</div>
	</div>
	<div class="contact_wrap">
		<div class="contact_content">
			<div class="step_img"><span class="step_box">Step 2</span></div>
			여 행 일 정 짜 기<br> 
			-총 3일 간의 즐거운 여행 일정을 선택할 수 있으며 도시 및 여행지 검색으로<br />
			편리하게 일정을 추가 할 수 있는 기능을 제공하고 있습니다.
			<div class="contact_img_wrap m-t-30"><img src="img/contact/schedule.jpg" class="contact_img"></div>
		</div>
	</div>
	<div class="contact_wrap">
