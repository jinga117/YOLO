    ...
    <div class="b-main-container" id="content">
         <div class="b-pop-places container">
            <h2 class="b-cont-title">
            	<c:if test="${food_id == 'f01'}">Restaurant Top5</c:if>
            	<c:if test="${food_id == 'f02'}">Bakery & Cafe Top5</c:if>
            </h2>
						...
						<div class="b-pop-place">
							...
							<div class="b-pop-place__desc clearfix">
								...
								<div class="b-pop-place-comment">
									<a href="http://${list.trip_site}" target="_blank"
									...
									</a> <span class="b-pop-place__view"><img
										...
										class="list_icon"></span> ${list.trip_view} <span
