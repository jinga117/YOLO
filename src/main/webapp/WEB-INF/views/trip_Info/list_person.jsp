						...
						<div class="b-pop-place">
							...
							<div class="b-pop-place__desc clearfix">
								<div class="b-pop-place__rating">
									<span class="b-pop-place__like"><i class="fa fa-heart"
										aria-hidden="true"></i></span> <span id="likeCount">${list.trip_like}</span>
								</div>
								<a href="detail_view?trip_id=${list.trip_id}"
									class="b-pop-place__name">${list.trip_nickname}</a>
								<h5 class="b-pop-place__cat">${list.trip_add1}
									${list.trip_add2}</h5>

								<div class="b-pop-place-comment">
									<a href="http://${list.trip_site}" target="_blank"
										class="b-pop-place-homepage" data-toggle="tooltip"
										data-placement="top" title="홈페이지 바로가기"><i
										class="fa fa-home" aria-hidden="true"></i></a> <span
										class="b-pop-place__view"><img src="img/heart_icon.png"
										class="list_icon"></span><span id="likeCount">${list.trip_like}</span>
									<span class="b-pop-place__view"><img
										src="img/view_icon.png" class="list_icon"></span>
									${list.trip_view} <span class="b-pop-place__view"><img
										src="img/review_icon.png" class="list_icon"></span>
									${list.trip_view}
								</div>
							</div>
						</div>
							...
							<div class="b-pop-place">
								...
								<div class="b-pop-place__desc clearfix">
									<a href="detail_view?trip_id=${list.trip_id}"
										...
										class="b-pop-place__name_txt">${list.trip_nickname}</span>
									</a>
									<h5 class="b-pop-place__cat">${list.trip_add1}
										${list.trip_add2}</h5>
									...
									<div class="b-pop-place-comment m--centered">
										<span class="b-pop-place__view"><img
											src="img/heart_icon.png" class="list_icon"></span><span
											id="likeCount">${list.trip_like}</span> <span
											class="b-pop-place__view"><img src="img/view_icon.png"
											class="list_icon"> ${list.trip_view}</span> <span
											class="b-pop-place__view"><img
											src="img/review_icon.png" class="list_icon">
											${list.trip_view}</span>
									</div>
								</div>
							</div>
