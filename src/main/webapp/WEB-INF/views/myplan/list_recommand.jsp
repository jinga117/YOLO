   ...
   <div class="b-pop-places container">
               ...
               <div class="b-pop-places__item">
                  <div class="b-pop-place">
                     ...
                     <div class="b-pop-place__desc clearfix">
                        <a href="detail_view_recommand?trip_id=${list.trip_id}&re_onum=re${sta.count}" class="b-pop-place__name">${list.trip_nickname}</a>
      ...
      <div id="viewList">
         <ul class="viewList_list" id="viewList_list">
            <!--  View all List 시작 -->
            <c:forEach items="${recommandList }" var="list" varStatus="sta">
               <li>
                  <div class="viewList_item">
                     <div class="b-pop-place">
                        <div class="b-pop-place__img">
                           <a href="detail_view_recommand?trip_id=${list.trip_id}"> <img width="370" height="245" class="b-pop-place__img__img" src="img/photo/${list.trip_id}.jpg"
